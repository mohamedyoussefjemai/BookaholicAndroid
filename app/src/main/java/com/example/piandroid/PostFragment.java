...
public class PostFragment extends Fragment implements View.OnTouchListener {

    CardViewPostAdapter cardViewPostAdapter;
        ...
        sw.setOnTouchListener(new OnSwipeTouchListener(getContext()) {
            ...
            public void onSwipeRight() {
                getActivity().getSupportFragmentManager()
                        ...
                        .addToBackStack(null)
                        .replace(R.id.fragment_container, new LibFragment())
                        .commit();            }
...
//clean cache storage
        ...
        if (isNetworkAvailable()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        prefEditor.putString("post", String.valueOf(jsonArray));
                        prefEditor.commit();
                        Log.i("test post ====>", String.valueOf(mPreferences.getString("post", null)));
                        ...
                        cardViewPostAdapter = new CardViewPostAdapter(getContext(), mainbooks);

                        recyclerView2.setAdapter(cardViewPostAdapter);
            ...
            String JsonArray = mPreferences.getString("post", null);
