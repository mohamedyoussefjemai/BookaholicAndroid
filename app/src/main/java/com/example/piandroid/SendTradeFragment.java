...
public class SendTradeFragment extends Fragment {
    ...
    CardViewSendTradeAdapter cardViewSendTradeAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View rootView;
        rootView = inflater.inflate(R.layout.fragment_send_trade, container, false);
        return rootView;
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        String url = "http://192.168.1.4:3000/requests/read-trade-sended/" + mPreferences.getString("username", null);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    recyclerView2 = view.findViewById(R.id.recycler_view_send_trade);


                    LinearLayoutManager layoutManager2 = new LinearLayoutManager(
                            getContext(), LinearLayoutManager.VERTICAL, false
                    );
                    cardViewSendTradeAdapter = new CardViewSendTradeAdapter(getContext(), requests);

                    recyclerView2.setAdapter(cardViewSendTradeAdapter);
