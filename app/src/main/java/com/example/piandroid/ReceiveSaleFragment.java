...
public class ReceiveSaleFragment extends Fragment {

    CardViewReceiveSaleAdapter cardViewReceiveSaleAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View rootView;
        rootView = inflater.inflate(R.layout.fragment_receive_sale, container, false);
        return rootView;
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        String url = "http://192.168.1.4:3000/requests/read-sale-received/" + mPreferences.getString("username", null);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    cardViewReceiveSaleAdapter = new CardViewReceiveSaleAdapter(getContext(), requests);

                    recyclerView2.setAdapter(cardViewReceiveSaleAdapter);
