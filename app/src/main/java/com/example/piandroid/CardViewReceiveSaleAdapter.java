 ...
 */
public class CardViewReceiveSaleAdapter extends RecyclerView.Adapter<CardViewReceiveSaleAdapter.ViewHolder> {
    ...
    public CardViewReceiveSaleAdapter(Context context, ArrayList<Requests> requests) {
    ...
    @NonNull
    @Override
    public CardViewReceiveSaleAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_receive_sale, parent, false);
        return new CardViewReceiveSaleAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(context)
                        .setTitle("Accept Sale")
                        .setMessage("Do you really want to accept this sale ?")
                                ...
                                try {
                                    ...
                                    StringRequest stringRequest = new StringRequest(Request.Method.PUT, url, new Response.Listener<String>() {
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            //toast login in
                                            Toast toast = Toast.makeText(context, "Sale Updated !", Toast.LENGTH_SHORT);
                                            toast.show();
                                            mPreferences = context.getSharedPreferences(filename, Context.MODE_PRIVATE);

                                            int sale = Integer.parseInt(mPreferences.getString("sale", null));
                                            final SharedPreferences.Editor prefEditor = mPreferences.edit();
                                            sale++;
                                            prefEditor.putString("sale", String.valueOf(sale));
                                            prefEditor.commit();
                                        }
        ...
        holder.reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(context)
                        .setTitle("Refuse Sale")
                        .setMessage("Do you really want to refuse this sale ?")
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView sender, price, etat, titlechange;
